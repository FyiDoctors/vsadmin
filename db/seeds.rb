...
Security.delete_all
secUser = Security.create([ role: "user", secret: "V1s1on2014!"])
secUser = Security.create([ role: "admin", secret: "adminpassword"])

ConfigSetting.delete_all

config = ConfigSetting.create([ name: "mode", value: "prod"])
config = ConfigSetting.create([ name: "email", value: "dean.skelton@gmail.com"])

Distribution.delete_all

distro = Distribution.create([email: "dean.skelton@fyidoctors.com"])
...
clinic = Clinic.create([ vendorid: "VN0003020", vsid: "20", vsvendorid: "THORNBORROW", name: "Dr. Derrick Thornborrow", address: "301 Dundas St. E, Waterdown, ON, L0R2H0", 	model_id: 1, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003022", vsid: "22", vsvendorid: "WATERDOWN", name: "Dr. Derrick Thornborrow", address: "301 Dundas St. E, Waterdown, ON, L0R2H0", 	model_id: 1, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003032", vsid: "32", vsvendorid: "JARRETT", name: "Dr. Carolyn Jarrett", address: "200 University Ave., Ste. 100, Toronto, ON, M5H3C6", 	model_id: 1, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003034", vsid: "34", vsvendorid: "AHOKAS", name: "Kevin Ahokas Optometry Professional Corporation", address: "535 Upper Wellington St., Hamilton, ON, L9A3D7", 	model_id: 1, province: 'ON', admin: true])
...
clinic = Clinic.create([ vendorid: "VN0003037", vsid: "37", vsvendorid: "MONTEIRO", name: "Jo-Anne Monteiro & Associates, Optometrists", address: "1960 Appleby Line, Suite 12, Burlington, ON, L7L0B7", 	model_id: 1, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003040", vsid: "40", vsvendorid: "DUBE", name: "Francis Dube, O.D.", address: "1264 Garrison Rd., Unit 4, Fort Erie, ON, L2A1P1", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003041", vsid: "41", vsvendorid: "SHER", name: "Dr. Morrie Sher", address: "7975 Yonge St., Unit 14, Innisfil, ON, L9S1L2", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003042", vsid: "42", vsvendorid: "HERSHORN", name: "Dr. Jason Hershorn - St. Clair Optometry", address: "1366 Yonge St., Ste. 103, Toronto, ON, M4T3A7", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003043", vsid: "43", vsvendorid: "NELSON", name: "Dr. Michael Nelson", address: "1-1200 Waverly St., Winnipeg, MB, R3T0P4", 	model_id: 1, province: 'MB', admin: true])
clinic = Clinic.create([ vendorid: "VN0003044", vsid: "44", vsvendorid: "GOLE", name: "Dr. Robert Gole", address: "480 Smith St., Arthur, ON, N0G1A0", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003045", vsid: "45", vsvendorid: "GOLE", name: "Dr. Robert Gole", address: "1100 A Davis Dr., Ste. 1, Newmarket, ON, L3Y8W8", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003046", vsid: "46", vsvendorid: "PAPADAKIS", name: "Finch Avenue Optometry & Low Vision Clinic", address: "244 Finch Ave., W, Toronto, ON, M2R 1M7", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003047", vsid: "47", vsvendorid: "GOLD", name: "Dr. Steven Gold", address: "11 Disera Dr., Unit 150, Thornhill, ON, L4J0A7", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003048", vsid: "48", vsvendorid: "BAHN", name: "Vi Tu Banh Optometry, Professional Corporation", address: "2 Elgin Park Dr., Unit D, Uxbridge, ON, L9P0B1", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003049", vsid: "49", vsvendorid: "KOGON", name: "Dr. Gary Kogon - Missassauga Optometric Clinic", address: "    2  Robert Speck Parkway,  Suite 150 Mississauga, ON, L4Z-1H8", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003050", vsid: "50", vsvendorid: "CHANG", name: "Yih Ling Chang Optometry, P.C.", address: "62 Ellesmere Rd., Scarborough, ON, M1R4C2", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003051", vsid: "51", vsvendorid: "LOWY", name: "Dr. Deborah Lowy", address: "1520 Steeles Ave., W., Ste 120 - A, Concord, ON, L4K3B9", 	model_id: 1, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003052", vsid: "52", vsvendorid: "CHALATURNYK", name: "Dr. T.W. Chalaturnyk & Associates", address: "679 Davis Dr., Unit 321, Newmarket, ON, L3Y5G8", 	model_id: 1, province: 'ON', admin: true])
clinic = Clinic.create([ vendorid: "VN0003053", vsid: "53", vsvendorid: "KAUL", name: "Dr. Annu Kaul", address: "18328 Lessard Rd., Edmonton, AB, T6M2W8", 	model_id: 2, province: 'AB', admin: false])
clinic = Clinic.create([ vendorid: "VN0003054", vsid: "54", vsvendorid: "Dr. Brent Westfall", name: "I Sight Optometry", address: "#4-2070 Harvey Ave., Kelowna, BC, VIY8P8", 	model_id: 2, province: 'BC', admin: true])
...
clinic = Clinic.create([ vendorid: "VN0003067", vsid: "67", vsvendorid: "DIBERARDINO", name: "Dr. Jack DiBerardino", address: "31 First St., Orangeville, ON, L9W 2C8", 	model_id: 2, province: 'ON', admin: false])
clinic = Clinic.create([ vendorid: "VN0003068", vsid: "68", vsvendorid: "SAMUELL01", name: "Dr. Richard Samuell", address: "25 Bayfield Main St. North, Bayfield, ON, N0M1G0", 	model_id: 2, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003089", vsid: "89", vsvendorid: "", name: "Dr. Dan Vespa", address: "360 Manning Road, Tecumseh , ON, N8N 5E1", 	model_id: 2, province: 'ON', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003095", vsid: "95", vsvendorid: "", name: "Dr. Priya Vohora", address: "102-18640 Fraser Hwy., Surrey, BC, V3S 7Y4", 	model_id: 2, province: 'BC', admin: false])
...
clinic = Clinic.create([ vendorid: "VN0003097", vsid: "97", vsvendorid: "", name: "Dr Danielle Frigault", address: "1624 Laurier St., Clarence-Rockland, ON, K4K 1M5", 	model_id: 2, province: 'ON', admin: true])
...
clinic = Clinic.create([ vendorid: "VN0003100", vsid: "100", vsvendorid: "", name: "Dr. Corina Buettner", address: "2828 St. Joseph Blvd., Orleans , ON, K1C 1G7 ", 	model_id: 2, province: 'ON', admin: true])
...
clinic = Clinic.create([ vendorid: "VN0003105", vsid: "105", vsvendorid: "", name: "Dr. Emile Gillezeau", address: "212-1885 Glenanna Road, Pickering, ON, L1V 6R6", 	model_id: 2, province: 'ON', admin: false]) 
